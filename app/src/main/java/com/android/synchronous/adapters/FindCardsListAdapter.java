...
public class FindCardsListAdapter extends ArrayAdapter<ParseUser> {
    private List<ParseUser> mFindContacts;
    private Context mContext;

    public FindCardsListAdapter(Context context, List<ParseUser> models){
        super(context, R.layout.card_row, models);
        mFindContacts = models;
        mContext = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ParseUser savedContact = mFindContacts.get(position);
