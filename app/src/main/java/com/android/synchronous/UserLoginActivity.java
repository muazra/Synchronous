...
public class UserLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParseFacebookUtils.initialize("544207925713704");
        ...
        mFBLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ParseFacebookUtils.logIn(UserLoginActivity.this, new LogInCallback() {
                    ...
                    public void done(ParseUser parseUser, ParseException e) {
                        if (parseUser == null) {
                            Toast.makeText(mContext, "Facebook Login unsuccessful.",
                                    Toast.LENGTH_SHORT).show();
                        } else if (parseUser.isNew()) {
                            Intent intent = new Intent(mContext, MainActivity.class);
                            startActivity(intent);

                            Toast.makeText(mContext, "Welcome to Synchronous!",
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Intent intent = new Intent(mContext, MainActivity.class);
                            startActivity(intent);

                            Log.d("MUAZ", ParseUser.getCurrentUser().getUsername());

                                    Toast.makeText(mContext, "Welcome Back!.",
                                            Toast.LENGTH_SHORT).show();
                        }
                    }
                });
